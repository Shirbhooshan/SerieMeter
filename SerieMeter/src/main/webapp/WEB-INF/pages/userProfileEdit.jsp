...
.ep-edit-form {
	width: 100%;
	max-width: 1000px;
	/* Slightly narrower to match tighter vertical proportions */
	display: flex;
	flex-direction: column;
	align-items: center;
}
...
.ep-right-panel input[type="password"], .ep-right-panel input[type="text"]
	{
	width: 100%;
	...
	<main class="ep-page-wrapper">
		<form action="${pageContext.request.contextPath}/UserProfileEdit"
			...
			<div class="ep-main-card">
				...
				<div class="ep-left-panel">
					...
					<div class="ep-photo-section">
						<div class="ep-pic-wrapper">
							...
							<c:choose>
								<c:when test="${not empty user.userProfile}">
									<img
										src="${pageContext.request.contextPath}/getimage?name=${user.userProfile}&type=user"
										alt="Profile Picture" class="ep-profile-pic"
										id="ep-img-preview">
								</c:when>
								<c:otherwise>
									<img
										src="${pageContext.request.contextPath}/assets/images/default_profile.jpg"
										alt="Profile Picture" class="ep-profile-pic"
										id="ep-img-preview">
								</c:otherwise>
							</c:choose>
						...
						<button type="button" class="ep-change-photo-btn"
							onclick="document.getElementById('ep-file-input').click()">
							Change Photo</button>
						<input type="file" id="ep-file-input" name="user_profile"
					...
					<div class="ep-input-group">
						...
						<div class="ep-field-wrapper">
							<img
								src="${pageContext.request.contextPath}/assets/icon/user.svg"
								alt="" class="ep-field-icon"> <input type="text"
								name="full_name" placeholder="${user.fullName}">
						</div>
					</div>
					...
					<div class="ep-input-group">
						...
						<div class="ep-field-wrapper">
							<img
								src="${pageContext.request.contextPath}/assets/icon/envelope.svg"
								alt="" class="ep-field-icon"> <input type="text"
				...
				<div class="ep-right-panel">
					...
					<h2>
						Password and<br>Security
					</h2>

					<div class="ep-input-group">
						<label>Current Password</label>
						<div class="ep-field-wrapper">
							<input type="password" name="current_password" id="ep-pass-cur">
							<img src="${pageContext.request.contextPath}/assets/icon/eye.svg"
								alt="Show/Hide" class="ep-eye-icon" id="ep-eye-cur"
					...
					<div class="ep-input-group">
						...
						<div class="ep-field-wrapper">
							<input type="password" name="new_password" id="ep-pass-new">
							<img src="${pageContext.request.contextPath}/assets/icon/eye.svg"
								alt="Show/Hide" class="ep-eye-icon" id="ep-eye-new"
					...
					<div class="ep-input-group">
						...
						<div class="ep-field-wrapper">
							<input type="password" name="confirm_password" id="ep-pass-conf">
							<img src="${pageContext.request.contextPath}/assets/icon/eye.svg"
								alt="Show/Hide" class="ep-eye-icon" id="ep-eye-conf"
			...
			<div class="ep-action-area">
				...
				<button type="button" class="ep-go-back-btn"
					onclick="history.back()">
					<img
						src="${pageContext.request.contextPath}/assets/icon/left-arrow.svg"
						alt="" style="width: 12px;"> <span class="ep-link-text">Go
						Back</span>
				</button>
