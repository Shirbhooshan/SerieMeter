...
.rating-pill:hover, .rating-pill.on {
	background: var(--orange);
	color: var(--white);
	border-color: var(--orange);
}
...
<body>
	...
	<nav class="navbar">
		<div class="navbar__logo">
			...
			<span><span class="logo-text-serie">Serie</span><span
				class="logo-text-meter">meter</span></span>
		</div>
	...
	<div class="page-body">
		...
		<aside class="sidebar">
			...
			<div class="genre-grid">
				...
				<div class="genre-tag" onclick="this.classList.toggle('on')">Science
					Fiction</div>
			...
			<button class="reset-btn" onclick="resetAll()">Reset All
				Filters</button>
		</aside>
		...
		<main class="content">
			...
			<div class="sort-row">
				<span class="sort-label">Sort By</span> <select class="sort-select">
			...
			<div class="cards-grid">
				...
				<div class="card">
					...
					<div class="card__row">
						<span class="card__title">School of Good &amp;...</span> <span
							class="card__year">2019</span>
					</div>
				...
				<div class="card">
					<div class="card__poster"></div>
					<div class="card__row">
						<span class="card__title">Alice In Wonder...</span> <span
							class="card__year">2021</span>
					</div>
				...
				<div class="card">
					<div class="card__poster"></div>
					<div class="card__row">
						<span class="card__title">Narnia</span> <span class="card__year">2018</span>
					</div>
				...
				<div class="card">
					<div class="card__poster"></div>
					<div class="card__row">
						<span class="card__title">The Secret of M...</span> <span
							class="card__year">2022</span>
					</div>
				...
				<div class="card">
					<div class="card__poster"></div>
					<div class="card__row">
						<span class="card__title">Coraline</span> <span class="card__year">2017</span>
					</div>
				...
				<div class="card">
					<div class="card__poster"></div>
					<div class="card__row">
						<span class="card__title">Kungfu Panda</span> <span
							class="card__year">2020</span>
					</div>
				...
				<div class="card">
					<div class="card__poster"></div>
					<div class="card__row">
						<span class="card__title">Up</span> <span class="card__year">2019</span>
					</div>
				...
				<div class="card">
					<div class="card__poster"></div>
					<div class="card__row">
						<span class="card__title">How To Train Your...</span> <span
							class="card__year">2021</span>
					</div>
