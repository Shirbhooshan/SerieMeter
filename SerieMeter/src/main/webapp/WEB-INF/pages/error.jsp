...
<body>
	...
	<main>
		<div class="error-container">
			...
			<div class="right-side">
				...
				<p class="description">This chapter of your cinematic journey
					doesn’t exist. The script has reached an unexpected end.</p>

				<div class="buttons">
					<a href="${pageContext.request.contextPath}/Home"
						class="btn btn-green">Return home</a> <a
						href="${pageContext.request.contextPath}/Explore"
						class="btn btn-outline">Search library</a>
				</div>
			</div>
	...
	<footer> &copy;2026 SERIEMETER </footer>
