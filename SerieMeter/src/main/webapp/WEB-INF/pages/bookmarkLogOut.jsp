				...
				<div class="page-container">
					...
					<div class="bm-main-layout">
						...
						<div class="bm-left-side">
							...
							<h1>
								Your Personal<br> <span class="bm-green-text">Archive</span>
								Your Personal<br> <span class="green-text">Archive</span>

							</h1>

							<p class="bm-subtitle">Keep track of every cinematic journey.
								Sign in to access your curated bookmarks across all your
								devices.</p>

							<div class="bm-btn-row">
								<a href="${pageContext.request.contextPath}/Login"
									class="bm-btn bm-btn-black"> <img
									src="assets/icon/login_icon.svg"> <!-- Login and Sign up buttons -->
									<div class="btn-row">
										<a href="${pageContext.request.contextPath}/Login"
											class="btn btn-black"> 
											<img
											src="assets/icon/login_icon.svg" alt="login logo"
											style="width: 18px; height: 18px;"> Login to View
											Bookmarks</a> 
											<a href="${pageContext.request.contextPath}/Register"
											class="bm-btn bm-btn-green">Sign up</a></a> <a
							...
							<div class="bm-right-card">
								<div class="bm-card-icon-circle">
									...
									<a href="${pageContext.request.contextPath}/Explore"
										class="bm-explore-link">Explore Trending</a> <a
