	...
	<div class="hero">
		...
		<div class="hero__content">
			<div class="hero__badges">
				<span class="badge badge--trending">TRENDING</span> <span
					class="badge badge--genre">[GENRE]</span>
			</div>
			<h1 class="hero__title">MOVIE NAME</h1>
			<div class="hero__meta">
				<span class="star">★</span><span>4.9</span> <span class="dot">•</span><span>2024</span>
				<span class="dot">•</span><span>~2h</span>
			</div>
		</div>
		<button class="hero__btn">
			View Details <img src="assets/icon/arrow-right.svg" alt="" />
		</button>
	</div>
			...
			<div class="grid-4">
				<div class="card">
					...
					<div class="card__meta">
						<span class="star">★</span><span>4.9</span><span class="genre-tag">[Genre]</span>
					</div>
				</div>
				<div class="card">
					<div class="card__poster"></div>
