...
<body>
	...
	<div class="page-header">
		<div class="page-header__left">
			<h1 class="page-header__title">Se<span class="ad-text-orange">ries</span></h1>
	...
	<div class="sm_section">
		...
		<div class="sm_grid_5">
			<c:choose>
				<c:when test="${empty serieList}">
					<p class="sm_empty_msg">No series added yet.</p>
				</c:when>
				<c:otherwise>
					<c:forEach var="media" items="${serieList}">
						<a
